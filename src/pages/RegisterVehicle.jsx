    ...
    if (currentStep < STEPS.length - 1) {
      ...
      const payload = {
        ...
        owner: {
          ...
          ...(updated.companyRegNumber && { companyRegNumber: updated.companyRegNumber }),
          ...(updated.passportNumber && { passportNumber: updated.passportNumber }),
        },
        registration: {
        ...
        insurance: {
          ...
          expiryDate: new Date(updated.insuranceExpiryDate).toISOString(),
          status: updated.insuranceStatus,
        },
      }
      mutate(payload)
    }
